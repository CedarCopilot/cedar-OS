...
## Installation Options for Cedar-OS Components

Our UI components (chat, spells, etc.) are published in an npm package called `cedar-os-components`. However, we also offer the option of downloading them locally (shadcn style) for full customization without relying on configurations. When running any of the above commands, you'll be asked to choose:

1. **Local installation (shadcn style)** - Downloads component source files locally

   - ✅ Full control and customization
   - ✅ No external dependencies after installation
   - ❌ Manual updates required

2. **NPM package installation** - Installs from `cedar-os-components` package
   - ✅ Easier updates
