...
@source "../node_modules/cedar-os-components/**/*.{js,ts,jsx,tsx}";
```
...
module.exports = {
	content: [
		...
		'./node_modules/cedar-os-components/**/*.{js,ts,jsx,tsx}',
	],
	// ... rest of your config
};
```
...
4. **Verify Installation**: Ensure both `cedar-os` and `cedar-os-components` are properly installed
