...
With one command, you can download a fully working chat. You also get all of the individual components of it, so you can customise styling, rendering, and functionality.
