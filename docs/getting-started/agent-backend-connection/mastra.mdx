...
// Non-streaming call - TypeScript enforces 'route' parameter
...
import { useTypedAgentConnection } from 'cedar-os';
import type { MastraParams } from 'cedar-os';
